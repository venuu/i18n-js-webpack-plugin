...
/*::
type Locale = string;
type TranslationLeafNode = string | number | boolean | null;
type Translation = TranslationLeafNode | Array<TranslationLeafNode> | { [key: string]: Translation };
...
module.exports = function makeTranslationGraphMinimizer(
  ...
  return function pickUsedTranslations(
    ...
    return (
      keypathsWithLocales(usedTranslationKeypaths, locales)
